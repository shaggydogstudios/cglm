...
CGLM_INLINE
void
glm_ivec4(ivec3_const v3, int last, ivec4 dest) {
  dest[0] = v3[0];
  dest[1] = v3[1];
  dest[2] = v3[2];
  dest[3] = last;
...
CGLM_INLINE
void
glm_ivec4_copy(ivec4_const a, ivec4 dest) {
  dest[0] = a[0];
  dest[1] = a[1];
  dest[2] = a[2];
  dest[3] = a[3];
...
CGLM_INLINE
void
glm_ivec4_add(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] = a[0] + b[0];
  dest[1] = a[1] + b[1];
  dest[2] = a[2] + b[2];
  dest[3] = a[3] + b[3];
...
CGLM_INLINE
void
glm_ivec4_adds(ivec4_const v, int s, ivec4 dest) {
  dest[0] = v[0] + s;
  dest[1] = v[1] + s;
  dest[2] = v[2] + s;
  dest[3] = v[3] + s;
...
CGLM_INLINE
void
glm_ivec4_sub(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] = a[0] - b[0];
  dest[1] = a[1] - b[1];
  dest[2] = a[2] - b[2];
  dest[3] = a[3] - b[3];
...
CGLM_INLINE
void
glm_ivec4_subs(ivec4_const v, int s, ivec4 dest) {
  dest[0] = v[0] - s;
  dest[1] = v[1] - s;
  dest[2] = v[2] - s;
  dest[3] = v[3] - s;
...
CGLM_INLINE
void
glm_ivec4_mul(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] = a[0] * b[0];
  dest[1] = a[1] * b[1];
  dest[2] = a[2] * b[2];
  dest[3] = a[3] * b[3];
...
CGLM_INLINE
void
glm_ivec4_scale(ivec4_const v, int s, ivec4 dest) {
  dest[0] = v[0] * s;
  dest[1] = v[1] * s;
  dest[2] = v[2] * s;
  dest[3] = v[3] * s;
...
CGLM_INLINE 
void 
glm_ivec4_addadd(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] += a[0] + b[0];
  dest[1] += a[1] + b[1];
  dest[2] += a[2] + b[2];
  dest[3] += a[3] + b[3];
...
CGLM_INLINE 
void 
glm_ivec4_addadds(ivec4_const a, int s, ivec4 dest) {
  dest[0] += a[0] + s;
  dest[1] += a[1] + s;
  dest[2] += a[2] + s;
  dest[3] += a[3] + s;
...
CGLM_INLINE 
void 
glm_ivec4_subadd(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] += a[0] - b[0];
  dest[1] += a[1] - b[1];
  dest[2] += a[2] - b[2];
  dest[3] += a[3] - b[3];
...
CGLM_INLINE 
void 
glm_ivec4_subadds(ivec4_const a, int s, ivec4 dest) {
  dest[0] += a[0] - s;
  dest[1] += a[1] - s;
  dest[2] += a[2] - s;
  dest[3] += a[3] - s;
...
CGLM_INLINE 
void 
glm_ivec4_muladd(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] += a[0] * b[0];
  dest[1] += a[1] * b[1];
  dest[2] += a[2] * b[2];
  dest[3] += a[3] * b[3];
...
CGLM_INLINE 
void 
glm_ivec4_muladds(ivec4_const a, int s, ivec4 dest) {
  dest[0] += a[0] * s;
  dest[1] += a[1] * s;
  dest[2] += a[2] * s;
  dest[3] += a[3] * s;
...
CGLM_INLINE 
void 
glm_ivec4_maxadd(ivec4_const a, ivec4_const b, ivec4 dest) {
...
CGLM_INLINE 
void 
glm_ivec4_minadd(ivec4_const a, ivec4_const b, ivec4 dest) {
...
CGLM_INLINE 
void 
glm_ivec4_subsub(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] -= a[0] - b[0];
  dest[1] -= a[1] - b[1];
  dest[2] -= a[2] - b[2];
  dest[3] -= a[3] - b[3];
...
CGLM_INLINE 
void 
glm_ivec4_subsubs(ivec4_const a, int s, ivec4 dest) {
  dest[0] -= a[0] - s;
  dest[1] -= a[1] - s;
  dest[2] -= a[2] - s;
  dest[3] -= a[3] - s;
...
CGLM_INLINE 
void 
glm_ivec4_addsub(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] -= a[0] + b[0];
  dest[1] -= a[1] + b[1];
  dest[2] -= a[2] + b[2];
  dest[3] -= a[3] + b[3];
...
CGLM_INLINE 
void 
glm_ivec4_addsubs(ivec4_const a, int s, ivec4 dest) {
  dest[0] -= a[0] + s;
  dest[1] -= a[1] + s;
  dest[2] -= a[2] + s;
  dest[3] -= a[3] + s;
...
CGLM_INLINE 
void 
glm_ivec4_mulsub(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] -= a[0] * b[0];
  dest[1] -= a[1] * b[1];
  dest[2] -= a[2] * b[2];
  dest[3] -= a[3] * b[3];
...
CGLM_INLINE 
void 
glm_ivec4_mulsubs(ivec4_const a, int s, ivec4 dest) {
  dest[0] -= a[0] * s;
  dest[1] -= a[1] * s;
  dest[2] -= a[2] * s;
  dest[3] -= a[3] * s;
...
CGLM_INLINE 
void 
glm_ivec4_maxsub(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] -= glm_imax(a[0], b[0]);
  dest[1] -= glm_imax(a[1], b[1]);
  dest[2] -= glm_imax(a[2], b[2]);
  dest[3] -= glm_imax(a[3], b[3]);
...
CGLM_INLINE 
void 
glm_ivec4_minsub(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] -= glm_imin(a[0], b[0]);
  dest[1] -= glm_imin(a[1], b[1]);
  dest[2] -= glm_imin(a[2], b[2]);
  dest[3] -= glm_imin(a[3], b[3]);
...
CGLM_INLINE
int
glm_ivec4_distance2(ivec4_const a, ivec4_const b) {
  int xd, yd, zd, wd;
  xd = a[0] - b[0];
  yd = a[1] - b[1];
  zd = a[2] - b[2];
...
CGLM_INLINE
float
glm_ivec4_distance(ivec4_const a, ivec4_const b) {
...
CGLM_INLINE
void
glm_ivec4_maxv(ivec4_const a, ivec4_const b, ivec4 dest) {
...
CGLM_INLINE
void
glm_ivec4_minv(ivec4_const a, ivec4_const b, ivec4 dest) {
  dest[0] = a[0] < b[0] ? a[0] : b[0];
  dest[1] = a[1] < b[1] ? a[1] : b[1];
  dest[2] = a[2] < b[2] ? a[2] : b[2];
  dest[3] = a[3] < b[3] ? a[3] : b[3];
...
CGLM_INLINE
void
glm_ivec4_abs(ivec4_const v, ivec4 dest) {
  dest[0] = abs(v[0]);
  dest[1] = abs(v[1]);
  dest[2] = abs(v[2]);
  dest[3] = abs(v[3]);
