...
CGLM_INLINE
void
glm_ivec2_copy(ivec2_const a, ivec2 dest) {
  dest[0] = a[0];
  dest[1] = a[1];
}
...
CGLM_INLINE
int
glm_ivec2_dot(ivec2_const a, ivec2_const b) {
...
CGLM_INLINE
int
glm_ivec2_cross(ivec2_const a, ivec2_const b) {
...
CGLM_INLINE
void
glm_ivec2_add(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] = a[0] + b[0];
  dest[1] = a[1] + b[1];
}
...
CGLM_INLINE
void
glm_ivec2_adds(ivec2_const v, int s, ivec2 dest) {
  dest[0] = v[0] + s;
  dest[1] = v[1] + s;
}
...
CGLM_INLINE
void
glm_ivec2_sub(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] = a[0] - b[0];
  dest[1] = a[1] - b[1];
}
...
CGLM_INLINE
void
glm_ivec2_subs(ivec2_const v, int s, ivec2 dest) {
  dest[0] = v[0] - s;
  dest[1] = v[1] - s;
}
...
CGLM_INLINE
void
glm_ivec2_mul(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] = a[0] * b[0];
  dest[1] = a[1] * b[1];
}
...
CGLM_INLINE
void
glm_ivec2_scale(ivec2_const v, int s, ivec2 dest) {
  dest[0] = v[0] * s;
  dest[1] = v[1] * s;
}
...
CGLM_INLINE
void
glm_ivec2_div(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] = a[0] / b[0];
  dest[1] = a[1] / b[1];
}
...
CGLM_INLINE
void
glm_ivec2_divs(ivec2_const v, int s, ivec2 dest) {
  dest[0] = v[0] / s;
  dest[1] = v[1] / s;
}
...
CGLM_INLINE
void
glm_ivec2_mod(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] = a[0] % b[0];
  dest[1] = a[1] % b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_addadd(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] += a[0] + b[0];
  dest[1] += a[1] + b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_addadds(ivec2_const a, int s, ivec2 dest) {
  dest[0] += a[0] + s;
  dest[1] += a[1] + s;
}
...
CGLM_INLINE 
void 
glm_ivec2_subadd(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] += a[0] - b[0];
  dest[1] += a[1] - b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_subadds(ivec2_const a, int s, ivec2 dest) {
  dest[0] += a[0] - s;
  dest[1] += a[1] - s;
}
...
CGLM_INLINE 
void 
glm_ivec2_muladd(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] += a[0] * b[0];
  dest[1] += a[1] * b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_muladds(ivec2_const a, int s, ivec2 dest) {
  dest[0] += a[0] * s;
  dest[1] += a[1] * s;
}
...
CGLM_INLINE 
void 
glm_ivec2_maxadd(ivec2_const a, ivec2_const b, ivec2 dest) {
...
CGLM_INLINE 
void 
glm_ivec2_minadd(ivec2_const a, ivec2_const b, ivec2 dest) {
...
CGLM_INLINE 
void 
glm_ivec2_subsub(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] -= a[0] - b[0];
  dest[1] -= a[1] - b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_subsubs(ivec2_const a, int s, ivec2 dest) {
  dest[0] -= a[0] - s;
  dest[1] -= a[1] - s;
}
...
CGLM_INLINE 
void 
glm_ivec2_addsub(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] -= a[0] + b[0];
  dest[1] -= a[1] + b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_addsubs(ivec2_const a, int s, ivec2 dest) {
  dest[0] -= a[0] + s;
  dest[1] -= a[1] + s;
}
...
CGLM_INLINE 
void 
glm_ivec2_mulsub(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] -= a[0] * b[0];
  dest[1] -= a[1] * b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_mulsubs(ivec2_const a, int s, ivec2 dest) {
  dest[0] -= a[0] * s;
  dest[1] -= a[1] * s;
}
...
CGLM_INLINE 
void 
glm_ivec2_maxsub(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] -= glm_imax(a[0], b[0]);
  dest[1] -= glm_imax(a[1], b[1]);
}
...
CGLM_INLINE 
void 
glm_ivec2_minsub(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] -= glm_imin(a[0], b[0]);
  dest[1] -= glm_imin(a[1], b[1]);
}
...
CGLM_INLINE
int
glm_ivec2_distance2(ivec2_const a, ivec2_const b) {
  int xd, yd;
  xd = a[0] - b[0];
  yd = a[1] - b[1];
  return xd * xd + yd * yd;
...
CGLM_INLINE
float
glm_ivec2_distance(ivec2_const a, ivec2_const b) {
...
CGLM_INLINE
bool
glm_ivec2_eq(ivec2_const v, int val) {
...
CGLM_INLINE
bool
glm_ivec2_eqv(ivec2_const a, ivec2_const b) {
  return a[0] == b[0]
         && a[1] == b[1];
}
...
CGLM_INLINE
void
glm_ivec2_maxv(ivec2_const a, ivec2_const b, ivec2 dest) {
...
CGLM_INLINE
void
glm_ivec2_minv(ivec2_const a, ivec2_const b, ivec2 dest) {
  dest[0] = a[0] < b[0] ? a[0] : b[0];
  dest[1] = a[1] < b[1] ? a[1] : b[1];
}
...
CGLM_INLINE
void
glm_ivec2_abs(ivec2_const v, ivec2 dest) {
  dest[0] = abs(v[0]);
  dest[1] = abs(v[1]);
}
