...
CGLM_INLINE
void
glm_aabb_transform(vec3_const box[2], mat4_const m, vec3 dest[2]) {
...
CGLM_INLINE
void
glm_aabb_merge(vec3_const box1[2], vec3_const box2[2], vec3 dest[2]) {
...
CGLM_INLINE
void
glm_aabb_crop(vec3_const box[2], vec3_const cropBox[2], vec3 dest[2]) {
...
CGLM_INLINE
void
glm_aabb_crop_until(vec3_const box[2],
...
CGLM_INLINE
bool
glm_aabb_frustum(vec3_const box[2], vec4_const planes[6]) {
  const float *p;
  float        dp;
  int          i;
...
CGLM_INLINE
bool
glm_aabb_isvalid(vec3_const box[2]) {
...
CGLM_INLINE
float
glm_aabb_size(vec3_const box[2]) {
...
CGLM_INLINE
float
glm_aabb_radius(vec3_const box[2]) {
...
CGLM_INLINE
void
glm_aabb_center(vec3_const box[2], vec3 dest) {
...
CGLM_INLINE
bool
glm_aabb_aabb(vec3_const box[2], vec3_const other[2]) {
...
CGLM_INLINE
bool
glm_aabb_sphere(vec3_const box[2], vec4_const s) {
  float dmin;
  int   a, b, c;
...
CGLM_INLINE
bool
glm_aabb_point(vec3_const box[2], vec3_const point) {
...
CGLM_INLINE
bool
glm_aabb_contains(vec3_const box[2], vec3_const other[2]) {
