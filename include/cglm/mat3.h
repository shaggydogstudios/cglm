...
CGLM_INLINE
void
glm_mat3_copy(mat3_const mat, mat3 dest) {
  dest[0][0] = mat[0][0];
  dest[0][1] = mat[0][1];
  dest[0][2] = mat[0][2];
...
CGLM_INLINE
void
glm_mat3_mul(mat3_const m1, mat3_const m2, mat3 dest) {
...
CGLM_INLINE
void
glm_mat3_transpose_to(mat3_const m, mat3 dest) {
  dest[0][0] = m[0][0];
  dest[0][1] = m[1][0];
  dest[0][2] = m[2][0];
  dest[1][0] = m[0][1];
...
CGLM_INLINE
void
glm_mat3_mulv(mat3_const m, vec3_const v, vec3 dest) {
  vec3 res;
...
CGLM_INLINE
void
glm_mat3_quat(mat3_const m, versor dest) {
  float trace, r, rinv;
...
CGLM_INLINE
void
glm_mat3_inv(mat3_const mat, mat3 dest) {
  float a = mat[0][0], b = mat[0][1], c = mat[0][2],
        d = mat[1][0], e = mat[1][1], f = mat[1][2],
        g = mat[2][0], h = mat[2][1], i = mat[2][2],
...
CGLM_INLINE
float
glm_mat3_rmc(vec3_const r, mat3_const m, vec3_const c) {
  vec3 tmp;
