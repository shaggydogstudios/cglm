...
CGLM_INLINE
void
glm_aabb2d_copy(vec2_const aabb[2], vec2 dest[2]) {
...
CGLM_INLINE
void
glm_aabb2d_transform(vec2_const aabb[2], mat3_const m, vec2 dest[2]) {
...
CGLM_INLINE
void
glm_aabb2d_merge(vec2_const aabb1[2], vec2_const aabb2[2], vec2 dest[2]) {
...
CGLM_INLINE
void
glm_aabb2d_crop(vec2_const aabb[2], vec2_const cropAabb[2], vec2 dest[2]) {
...
CGLM_INLINE
void
glm_aabb2d_crop_until(vec2_const aabb[2],
...
CGLM_INLINE
bool
glm_aabb2d_isvalid(vec2_const aabb[2]) {
...
CGLM_INLINE
float
glm_aabb2d_diag(vec2_const aabb[2]) {
...
CGLM_INLINE
void
glm_aabb2d_sizev(vec2_const aabb[2], vec2 dest) {
...
CGLM_INLINE
float
glm_aabb2d_radius(vec2_const aabb[2]) {
...
CGLM_INLINE
void
glm_aabb2d_center(vec2_const aabb[2], vec2 dest) {
...
CGLM_INLINE
bool
glm_aabb2d_aabb(vec2_const aabb[2], vec2_const other[2]) {
...
CGLM_INLINE
bool
glm_aabb2d_circle(vec2_const aabb[2], vec3_const c) {
  float dmin;
  int   a, b;
...
CGLM_INLINE
bool
glm_aabb2d_point(vec2_const aabb[2], vec2_const point) {
...
CGLM_INLINE
bool
glm_aabb2d_contains(vec2_const aabb[2], vec2_const other[2]) {
