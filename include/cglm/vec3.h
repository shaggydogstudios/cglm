...
CGLM_INLINE
void
glm_vec3(vec4_const v4, vec3 dest) {
  dest[0] = v4[0];
  dest[1] = v4[1];
  dest[2] = v4[2];
}
...
CGLM_INLINE
void
glm_vec3_copy(vec3_const a, vec3 dest) {
  dest[0] = a[0];
  dest[1] = a[1];
  dest[2] = a[2];
}
...
CGLM_INLINE
float
glm_vec3_dot(vec3_const a, vec3_const b) {
...
CGLM_INLINE
float
glm_vec3_norm_one(vec3_const v) {
  vec3 t;
  glm_vec3_abs(v, t);
...
CGLM_INLINE
float
glm_vec3_norm_inf(vec3_const v) {
  vec3 t;
  glm_vec3_abs(v, t);
...
CGLM_INLINE
void
glm_vec3_add(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] = a[0] + b[0];
  dest[1] = a[1] + b[1];
  dest[2] = a[2] + b[2];
}
...
CGLM_INLINE
void
glm_vec3_adds(vec3_const v, float s, vec3 dest) {
  dest[0] = v[0] + s;
  dest[1] = v[1] + s;
  dest[2] = v[2] + s;
}
...
CGLM_INLINE
void
glm_vec3_sub(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] = a[0] - b[0];
  dest[1] = a[1] - b[1];
  dest[2] = a[2] - b[2];
}
...
CGLM_INLINE
void
glm_vec3_subs(vec3_const v, float s, vec3 dest) {
  dest[0] = v[0] - s;
  dest[1] = v[1] - s;
  dest[2] = v[2] - s;
}
...
CGLM_INLINE
void
glm_vec3_mul(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] = a[0] * b[0];
  dest[1] = a[1] * b[1];
  dest[2] = a[2] * b[2];
}
...
CGLM_INLINE
void
glm_vec3_scale(vec3_const v, float s, vec3 dest) {
  dest[0] = v[0] * s;
  dest[1] = v[1] * s;
  dest[2] = v[2] * s;
}
...
CGLM_INLINE
void
glm_vec3_scale_as(vec3_const v, float s, vec3 dest) {
  float norm;
...
CGLM_INLINE
void
glm_vec3_div(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] = a[0] / b[0];
  dest[1] = a[1] / b[1];
  dest[2] = a[2] / b[2];
}
...
CGLM_INLINE
void
glm_vec3_divs(vec3_const v, float s, vec3 dest) {
  dest[0] = v[0] / s;
  dest[1] = v[1] / s;
  dest[2] = v[2] / s;
}
...
CGLM_INLINE
void
glm_vec3_addadd(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] += a[0] + b[0];
  dest[1] += a[1] + b[1];
  dest[2] += a[2] + b[2];
}
...
CGLM_INLINE
void
glm_vec3_subadd(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] += a[0] - b[0];
  dest[1] += a[1] - b[1];
  dest[2] += a[2] - b[2];
}
...
CGLM_INLINE
void
glm_vec3_muladd(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] += a[0] * b[0];
  dest[1] += a[1] * b[1];
  dest[2] += a[2] * b[2];
}
...
CGLM_INLINE
void
glm_vec3_muladds(vec3_const a, float s, vec3 dest) {
  dest[0] += a[0] * s;
  dest[1] += a[1] * s;
  dest[2] += a[2] * s;
}
...
CGLM_INLINE
void
glm_vec3_maxadd(vec3_const a, vec3_const b, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_minadd(vec3_const a, vec3_const b, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_subsub(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] -= a[0] - b[0];
  dest[1] -= a[1] - b[1];
  dest[2] -= a[2] - b[2];
}
...
CGLM_INLINE
void
glm_vec3_addsub(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] -= a[0] + b[0];
  dest[1] -= a[1] + b[1];
  dest[2] -= a[2] + b[2];
}
...
CGLM_INLINE
void
glm_vec3_mulsub(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] -= a[0] * b[0];
  dest[1] -= a[1] * b[1];
  dest[2] -= a[2] * b[2];
}
...
CGLM_INLINE
void
glm_vec3_mulsubs(vec3_const a, float s, vec3 dest) {
  dest[0] -= a[0] * s;
  dest[1] -= a[1] * s;
  dest[2] -= a[2] * s;
}
...
CGLM_INLINE
void
glm_vec3_maxsub(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] -= glm_max(a[0], b[0]);
  dest[1] -= glm_max(a[1], b[1]);
  dest[2] -= glm_max(a[2], b[2]);
}
...
CGLM_INLINE
void
glm_vec3_minsub(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] -= glm_min(a[0], b[0]);
  dest[1] -= glm_min(a[1], b[1]);
  dest[2] -= glm_min(a[2], b[2]);
}
...
CGLM_INLINE
void
glm_vec3_negate_to(vec3_const v, vec3 dest) {
  dest[0] = -v[0];
  dest[1] = -v[1];
  dest[2] = -v[2];
}
...
CGLM_INLINE
void
glm_vec3_normalize_to(vec3_const v, vec3 dest) {
  float norm;
...
CGLM_INLINE
void
glm_vec3_cross(vec3_const a, vec3_const b, vec3 dest) {
  vec3 c;
...
CGLM_INLINE
void
glm_vec3_crossn(vec3_const a, vec3_const b, vec3 dest) {
...
CGLM_INLINE
float
glm_vec3_angle(vec3_const a, vec3_const b) {
  float norm, dot;
...
CGLM_INLINE
void
glm_vec3_rotate(vec3 v, float angle, vec3_const axis) {
  vec3   v1, v2, k;
  float  c, s;
...
CGLM_INLINE
void
glm_vec3_rotate_m4(mat4 m, vec3_const v, vec3 dest) {
  vec4 x, y, z, res;
...
CGLM_INLINE
void
glm_vec3_rotate_m3(mat3_const m, vec3_const v, vec3 dest) {
  vec4 res, x, y, z;
...
CGLM_INLINE
void
glm_vec3_proj(vec3_const a, vec3_const b, vec3 dest) {
  glm_vec3_scale(b,
...
CGLM_INLINE
void
glm_vec3_center(vec3_const a, vec3_const b, vec3 dest) {
...
CGLM_INLINE
float
glm_vec3_distance2(vec3_const a, vec3_const b) {
...
CGLM_INLINE
float
glm_vec3_distance(vec3_const a, vec3_const b) {
...
CGLM_INLINE
void
glm_vec3_maxv(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] = glm_max(a[0], b[0]);
  dest[1] = glm_max(a[1], b[1]);
  dest[2] = glm_max(a[2], b[2]);
}
...
CGLM_INLINE
void
glm_vec3_minv(vec3_const a, vec3_const b, vec3 dest) {
  dest[0] = glm_min(a[0], b[0]);
  dest[1] = glm_min(a[1], b[1]);
  dest[2] = glm_min(a[2], b[2]);
}
...
CGLM_INLINE
void
glm_vec3_ortho(vec3_const v, vec3 dest) {
  float ignore;
...
CGLM_INLINE
void
glm_vec3_lerp(vec3_const from, vec3_const to, float t, vec3 dest) {
  vec3 s, v;
...
CGLM_INLINE
void
glm_vec3_lerpc(vec3_const from, vec3_const to, float t, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_mix(vec3_const from, vec3_const to, float t, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_mixc(vec3_const from, vec3_const to, float t, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_step(vec3_const edge, vec3_const x, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_smoothstep_uni(float edge0, float edge1, vec3_const x, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_smoothstep(vec3_const edge0, vec3_const edge1, vec3_const x, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_smoothinterp(vec3_const from, vec3_const to, float t, vec3 dest) {
  vec3 s, v;
...
CGLM_INLINE
void
glm_vec3_smoothinterpc(vec3_const from, vec3_const to, float t, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_swizzle(vec3_const v, int mask, vec3 dest) {
  vec3 t;
...
CGLM_INLINE
void
glm_cross(vec3_const a, vec3_const b, vec3 d) {
...
CGLM_INLINE
float
glm_dot(vec3_const a, vec3_const b) {
...
CGLM_INLINE
void
glm_normalize_to(vec3_const v, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_faceforward(vec3_const n, vec3_const v, vec3_const nref, vec3 dest) {
...
CGLM_INLINE
void
glm_vec3_reflect(vec3_const v, vec3_const n, vec3 dest) {
  vec3 temp;
...
CGLM_INLINE
bool
glm_vec3_refract(vec3_const v, vec3_const n, float eta, vec3 dest) {
  float ndi, eni, k;
