...
CGLM_INLINE
void
glm_mat4_transp_wasm(mat4_const m, mat4 dest) {
...
CGLM_INLINE
void
glm_mat4_mul_wasm(mat4_const m1, mat4_const m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
CGLM_INLINE
void
glm_mat4_mulv_wasm(mat4_const m, vec4_const v, vec4 dest) {
...
CGLM_INLINE
float
glm_mat4_det_wasm(mat4_const mat) {
...
CGLM_INLINE
void
glm_mat4_inv_fast_wasm(mat4_const mat, mat4 dest) {
...
CGLM_INLINE
void
glm_mat4_inv_wasm(mat4_const mat, mat4 dest) {
  glmm_128 r0, r1, r2, r3,
         v0, v1, v2, v3,
         t0, t1, t2, t3, t4, t5,
         x0, x1, x2, x3, x4, x5, x6, x7, x8, x9;
