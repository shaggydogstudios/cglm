...
CGLM_INLINE
void
glm_ortho_aabb_rh_no(vec3_const box[2], mat4 dest) {
...
CGLM_INLINE
void
glm_ortho_aabb_p_rh_no(vec3_const box[2], float padding, mat4 dest) {
...
CGLM_INLINE
void
glm_ortho_aabb_pz_rh_no(vec3_const box[2], float padding, mat4 dest) {
  glm_ortho_rh_no(box[0][0],              box[1][0],
                  box[0][1],              box[1][1],
                -(box[1][2] + padding), -(box[0][2] - padding),
                  dest);
