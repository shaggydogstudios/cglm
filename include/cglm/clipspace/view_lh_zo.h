...
CGLM_INLINE
void
glm_lookat_lh_zo(vec3_const eye, vec3_const center, vec3_const up, mat4 dest) {
...
CGLM_INLINE
void
glm_look_lh_zo(vec3_const eye, vec3_const dir, vec3_const up, mat4 dest) {
...
CGLM_INLINE
void
glm_look_anyup_lh_zo(vec3_const eye, vec3_const dir, mat4 dest) {
