...
CGLM_INLINE
void
glm_unprojecti_no(vec3_const pos, mat4_const invMat, vec4_const vp, vec3 dest) {
  vec4 v;
...
CGLM_INLINE
void
glm_project_no(vec3_const pos, mat4_const m, vec4_const vp, vec3 dest) {
...
CGLM_INLINE
float
glm_project_z_no(vec3_const v, mat4_const m) {
  float z, w;
