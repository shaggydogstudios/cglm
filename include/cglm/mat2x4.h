...
CGLM_INLINE
void
glm_mat2x4_copy(mat2x4_const src, mat2x4 dest) {
...
glm_mat2x4_zero(mat2x4 m) {
  CGLM_ALIGN_MAT_IF mat2x4 t = GLM_MAT2X4_ZERO_INIT;
  glm_mat2x4_copy(t, m);
}
...
CGLM_INLINE
void
glm_mat2x4_mul(mat2x4_const m1, mat4x2_const m2, mat4 dest) {
...
CGLM_INLINE
void
glm_mat2x4_mulv(mat2x4_const m, vec2_const v, vec4 dest) {
  float v0 = v[0], v1 = v[1];
...
CGLM_INLINE
void
glm_mat2x4_transpose(mat2x4_const src, mat4x2 dest) {
