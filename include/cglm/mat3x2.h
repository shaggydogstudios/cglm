...
CGLM_INLINE
void
glm_mat3x2_copy(mat3x2_const src, mat3x2 dest) {
...
glm_mat3x2_zero(mat3x2 m) {
  CGLM_ALIGN_MAT_IF mat3x2 t = GLM_MAT3X2_ZERO_INIT;
  glm_mat3x2_copy(t, m);
}
...
CGLM_INLINE
void
glm_mat3x2_mul(mat3x2_const m1, mat2x3_const m2, mat2 dest) {
...
CGLM_INLINE
void
glm_mat3x2_mulv(mat3x2_const m, vec3_const v, vec2 dest) {
...
CGLM_INLINE
void
glm_mat3x2_transpose(mat3x2_const src, mat2x3 dest) {
