...
CGLM_INLINE
void
glm_mat4x2_copy(mat4x2_const src, mat4x2 dest) {
...
glm_mat4x2_zero(mat4x2 m) {
  CGLM_ALIGN_MAT_IF mat4x2 t = GLM_MAT4X2_ZERO_INIT;
  glm_mat4x2_copy(t, m);
}
...
CGLM_INLINE
void
glm_mat4x2_mul(mat4x2_const m1, mat2x4_const m2, mat2 dest) {
...
CGLM_INLINE
void
glm_mat4x2_mulv(mat4x2_const m, vec4_const v, vec2 dest) {
...
CGLM_INLINE
void
glm_mat4x2_transpose(mat4x2_const m, mat2x4 dest) {
