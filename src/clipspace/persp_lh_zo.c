...
CGLM_EXPORT
void
glmc_persp_decomp_lh_zo(mat4_const proj,
...
CGLM_EXPORT
void
glmc_persp_decompv_lh_zo(mat4_const proj, float dest[6]) {
  glm_persp_decompv_lh_zo(proj, dest);
}

CGLM_EXPORT
void
glmc_persp_decomp_x_lh_zo(mat4_const proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_y_lh_zo(mat4_const proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_z_lh_zo(mat4_const proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_far_lh_zo(mat4_const proj, float * __restrict farZ) {
  glm_persp_decomp_far_lh_zo(proj, farZ);
}

CGLM_EXPORT
void
glmc_persp_decomp_near_lh_zo(mat4_const proj, float * __restrict nearZ) {
  glm_persp_decomp_near_lh_zo(proj, nearZ);
}

CGLM_EXPORT
void
glmc_persp_sizes_lh_zo(mat4_const proj, float fovy, vec4 dest) {
  glm_persp_sizes_lh_zo(proj, fovy, dest);
}

CGLM_EXPORT
float
glmc_persp_fovy_lh_zo(mat4_const proj) {
  return glm_persp_fovy_lh_zo(proj);
}

CGLM_EXPORT
float
glmc_persp_aspect_lh_zo(mat4_const proj) {
